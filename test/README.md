...
| `khgdOutline.test.js` | ✅ Có (import prompt/limits) | **Phiên 49.** Đọc Markdown SGK THẬT (`test/fixtures/khgd/`: Tiếng Anh 7 Unit 1, Toán 7 Chương I) → dòng bài học + đoạn trích cho Khung KHGD THCS/THPT; prompt AI luôn ưu tiên nội dung Markdown; `sanitizeKhgdLessons`, trần bài, chia lô AI. |
