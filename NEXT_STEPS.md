...
| 27 | Khung KHGD Tiểu học: số tiết mỗi Bài (Toán/Đạo đức/TNXH...) và mẫu giáo viên cho môn ngoài Tiếng Việt | Phiên 48b: Markdown SGK KHÔNG ghi số tiết nên các môn ngoài Tiếng Việt đang mặc định 1 tiết/bài (Tiếng Anh: 1 tiết/Lesson - giả định chưa kiểm chứng). Hoan chọn: (a) ghi `(N tiết)` vào tiêu đề Bài/Lesson trong Markdown - bộ đọc tự nhận, không cần sửa code; hoặc (b) giáo viên tự sửa "Số tiết" ở bảng. Cũng chưa có ảnh/mẫu KHGD Tiểu học của giáo viên cho Toán/Tiếng Anh/Đạo đức/TNXH để biết có cần tách theo hoạt động như Tiếng Việt không (không tự bịa cấu trúc). Cũng chưa kiểm tra Tiếng Việt Lớp 1/3/4/5 và chương 3+ của Lớp 2 (`TIENG_VIET_TIET_RULES` mới đối chiếu Lớp 2 tuần 1–8). |
